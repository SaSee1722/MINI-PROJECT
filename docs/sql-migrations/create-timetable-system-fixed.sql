-- INTERACTIVE TIMETABLE SYSTEM (FIXED VERSION)
...
DROP POLICY IF EXISTS "Staff and admins can manage timetable" ON timetable;
DROP POLICY IF EXISTS "Anyone can view period times" ON period_times;
DROP POLICY IF EXISTS "Anyone can view period attendance" ON period_attendance;
DROP POLICY IF EXISTS "Staff and admins can mark period attendance" ON period_attendance;
DROP POLICY IF EXISTS "Anyone can view period student attendance" ON period_student_attendance;
DROP POLICY IF EXISTS "Staff and admins can mark period student attendance" ON period_student_attendance;
